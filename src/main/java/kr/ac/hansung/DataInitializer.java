...
public class DataInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        if (productRepository.count() == 0) {
            ...
            productRepository.save(new Product("로지텍 MX Master 3S", 1290000, "무선 고정밀 업무용 마우스", 75));
            ...
            productRepository.save(new Product("닌텐도 스위치 2", 4590000, "휴대·거치 겸용 게임 콘솔", 0));
            productRepository.save(new Product("애플 에어팟 프로 3", 3590000, "공간 음향 지원 무선 이어폰", 55));

            System.out.println("샘플 상품 20건 생성 완료");
        }
    }
}
